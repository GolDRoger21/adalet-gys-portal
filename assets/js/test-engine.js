...
class UIManager {
    ...
    switchResultTab(tabName) { 
        ...
        this.dom.wrongAnswersPanel.classList.toggle('hidden', !isWrongTab); 
        this.dom.markedQuestionsPanel.classList.toggle('hidden', isWrongTab); 
        this.dom.wrongAnswersTab.classList.toggle('tab-active', isWrongTab); 
        this.dom.markedQuestionsTab.classList.toggle('tab-active', !isWrongTab); 
    }
